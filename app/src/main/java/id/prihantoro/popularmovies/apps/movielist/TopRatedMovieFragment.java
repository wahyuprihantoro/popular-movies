...
@EFragment(R.layout.fragment_top_rated_movie)
public class TopRatedMovieFragment extends Fragment implements MovieListView {
    ...
    private void loadMoreItems() {
        ...
        presenter.getTopRatedMovies(currentpage);
    }
